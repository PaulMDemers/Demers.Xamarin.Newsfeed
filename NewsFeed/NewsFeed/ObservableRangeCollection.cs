...
namespace NewsFeed
{
    public class ObservableRangeCollection<T> : ObservableCollection<T>
    {
        ...
        /// <summary> 
        /// Inserts the elements of the specified collection to the index of ObservableCollection(Of T). 
        /// </summary> 
        public void InsertRange(int index, IEnumerable<T> collection, NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add)
        {
            ...
            var itemsAdded = InsertArrangeCore(index, collection);
